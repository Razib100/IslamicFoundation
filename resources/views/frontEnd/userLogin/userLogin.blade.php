...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('public/frontEnd')}}/css/userLogin.css">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form id="login-form" action="{{ url('/reader-login') }}" method="post" role="form" style="display: block;">
                                    @csrf
                                ...
                                <form id="register-form" action="{{ url('/reader-register') }}" method="post" role="form" style="display: none;" onsubmit="return myFun()">
                                    @csrf
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="phoneNumber" name="phoneNumber" id="mobileNumber" tabindex="2" class="form-control" placeholder="Phone Number"><br>
                                    ...
                                    <a href="{{url('/')}}"><button class="btn btn-danger">Back</button></a>
