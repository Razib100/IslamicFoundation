...
@section('mainContent')
<section id="contact-header" class="py-5 text-light text-center">
    <div class="dark-overlay">
        <div class="container">
            <div class="col pt-5 mt-5">
                <h2 class="my-3">Contact US</h2>
                <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia magni, aspernatur odit minus praesentium dolor atque, incidunt provident molestias ipsa.</p>
            </div>
        </div>
    </div>
</section>
